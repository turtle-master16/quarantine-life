...
screen about():
    ...
    use game_menu(_("About"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("This template is done by {a=https://nadianova.itch.io/}Nadia Nova{/a}. You can use this template for free for anything you want, no credit required.\n\nSpecial thanks for {a=https://github.com/robotlolita/cute-demon-crashers}Cute Demon Crashers{/a} for the original code, which I built on, and also letting me use the phone sprite!\n\nMade with {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t]")
