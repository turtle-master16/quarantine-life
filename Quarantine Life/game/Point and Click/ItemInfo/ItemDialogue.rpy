define object_dialogue = {
    ...
    "phone":        "I'll check my phone later.",
    "pencilCan":    "Here are the pencils, why is the thick one in the living room?.",
    "pictureBdrm":  "My bedroom mirror.",
    "pillow":       "Comfies, I'll cuddle with you later.",
    "plant":        "The house plants are growing quite nicely.",
    "poster":       "Something is written at the back of the poster. \n{b}_ 0 _ _{/b}",
    "sofa":         "Maybe later.",
    "studyTable":   "A safe that needs a 4-digit code to unlock.",
    ...
    "painting":     "There’s something written at the corner of the frame. \n{b}_ _ 2 _{/b}",
    "plant":        "What a decoration, even in the kitchen.",
    "sanitizer":    "Here’s my hand sanitizer.",
    "saucepan":     "Shiny! I can see my reflection in it.",
